seqfile = Chiroptera_C9.aln													* sequence data file name
treefile = Chiroptera_C9.nwk  							* tree structure file name
outfile = Chiroptera_C9.aln.F3x4.M1vsM2.out											* main result file name
