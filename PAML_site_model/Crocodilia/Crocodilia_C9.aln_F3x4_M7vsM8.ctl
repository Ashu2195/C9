seqfile = Crocodilia_C9.aln													* sequence data file name
treefile = Crocodilia_C9.nwk  							* tree structure file name
outfile = Crocodilia_C9.aln.F3x4.M7vsM8.out											* main result file name
