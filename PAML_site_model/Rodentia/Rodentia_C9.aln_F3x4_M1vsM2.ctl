seqfile = Rodentia_C9.aln													* sequence data file name
treefile = Rodentia_C9.nwk  							* tree structure file name
outfile = Rodentia_C9.aln.F3x4.M1vsM2.out											* main result file name
