seqfile = Squamata_C9.aln													* sequence data file name
treefile = Squamata_C9.nwk  							* tree structure file name
outfile = Squamata_C9.aln.F3x4.M1vsM2.out											* main result file name
