seqfile = Insectivora_C9.aln													* sequence data file name
treefile = Insectivora_C9.nwk  							* tree structure file name
outfile = Insectivora_C9.aln.F3x4.M1vsM2.out											* main result file name
