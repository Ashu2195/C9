      seqfile = Pholidota_C9.aln.faa * sequence data filename
     treefile = Manis_pentadactyla.nwk      * tree structure file name
      outfile = Manis_pentadactyla_F1x4_bneutral.out        * main result file name
