      seqfile = Birds_C9.aln.faa * sequence data filename
     treefile = Stachyridopsis_ruficeps.nwk      * tree structure file name
      outfile = Stachyridopsis_ruficeps_F1x4_bneutral.out        * main result file name
