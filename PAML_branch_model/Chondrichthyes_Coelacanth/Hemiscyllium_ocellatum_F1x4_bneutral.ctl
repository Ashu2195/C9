      seqfile = Chondrichthyes_Coelacanth_C9.aln.faa * sequence data filename
     treefile = Hemiscyllium_ocellatum.nwk      * tree structure file name
      outfile = Hemiscyllium_ocellatum_F1x4_bneutral.out        * main result file name
